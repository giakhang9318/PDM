...
//        collectInfor();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Checking Students Attendance System");
        jPanel2.add(jLabel1);

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 670, 70));
...
//        String connectionUrl = "jdbc:mysql://localhost:3306/stadium_booking_2?user=root&password=123456789";
        ...
        try (Connection con = DriverManager.getConnection(connectionUrl); java.sql.Statement stmt = con.createStatement();) {
            String SQL = "select * from user where teacher_gmail='"+email+"' and teacher_pass='"+pass+"'";
            ...
            if("admin@admin".equals(email) && "admin".equals(pass)){
                ...
                while(rs.next()){
                String user = rs.getNString("teacher_gmail");
                String passw = rs.getNString("teacher_pass");
